...
- I tend to look at people's logic when reviewing code. For example, I'm always 
  looking for smarter/shorter/faster ways to write programs. Of course, I don't 
  want to sacrifice readability, so generally, I like to look for logical flow
  _and_ readability. This inspiration comes from the bus example Aaron mentioned
  the other day. If the people in charge of the code were to just get up and leave, 
  could the program still be worked? This is the biggest critique I seek when asking 
  someone to review my code.

- Containers help store objects in an organized way that follow specific access rules. 
  We can take a less abstract approach and visualize containers as physical, standardized
  shipping containers. These help in the shipping of various types of products. Instead of 
  having to look for someone who specializes in shipping, say bails of hay, we can simply 
  pack our hay in a standardized shipping container, which can then be shipped by anyone 
  to anywhere we wish it to go. Software containers work the same way.
